...
var aws_xray_sdk_core_1 = __webpack_require__(/*! aws-xray-sdk-core */ "aws-xray-sdk-core");
exports.handler = function (event, context) { return __awaiter(void 0, void 0, void 0, function () {
    var segment, body;
    return __generator(this, function (_a) {
        segment = new aws_xray_sdk_core_1.Segment('hello.handler');
        try {
            body = { event: event, context: context, message: 'Hello World!' };
            return [2 /*return*/, {
                    statusCode: 200,
...
module.exports = require("aws-xray-sdk-core");;
